          ...
          <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"> FARM<span class="logo-dec">ACIA </span></a>
              </div>
          ...
          <div class="container">
            <div class="row">
              <div class="banner-info text-center wow fadeIn delay-05s">
                ...
                <h2 class="bnr-sub-title">MY <STRong>FARMACIA</STRong></h2>
                <p class="bnr-para">La farmacia es la ciencia y práctica de la preparación, conservación, presentación y dispensación de medicamentos; también es el lugar donde se preparan, dispensan y venden los productos de parafarmacia y medicinales. Esta definición es la más universal y clásica, que se solapa con el concepto de Farmacia Galénica.​</p>
                <div class="brn-btn">
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="wrap-item text-center">
              ...
              <div class="item-img">
                <img src="img/icons8-caduceo-100.png">
              </div>
              <h3 class="pad-bt15">Bienestar</h3>
              <p>Siempre le ofrecemos a nuestros clientes un excelente servicio para permitirles el estar y sentirse bien en nuestra compañia.</p>
            </div>
          </div>
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="wrap-item text-center">
              <div class="item-img">
                <img src="img/icons8-píldora-96.png">
              </div>
              <h3 class="pad-bt15">Calidad</h3>
              <p>Meidcamentos de calidad, excelente servicio.</p>
            </div>
          </div>
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="wrap-item text-center">
              <div class="item-img">
                <img src="img/icons8-gente-trabajando-juntos-100.png">
              </div>
              <h3 class="pad-bt15">Trabajo en equipo</h3>
              <p>Nos enfocamos en ser un grupo amigable y razonable ante cada situacion para desarrollar respuestas optimas.</p>
            </div>
          </div>
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="wrap-item text-center">
              <div class="item-img">
                <img src="img/icons8-contraseña-96.png">
              </div>
              <h3 class="pad-bt15">Seguridad</h3>
              <p>Nos enfocamos en proteger tus datos para tu comodidad.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="service-item">
            <h3><span>E</span>ficazia</h3>
            <p>Este software esta totalmente optimizado para permitirle a los clientes una buena utilidad en el momento. </p>
      
          </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="service-item">
            <h3><span>P</span>roblematicas</h3>
            <p>Resolvemos problematicas nacionales mediante este software para resolver una inquietud nacional</p>
       
          </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="service-item">
            <h3><span>S</span>oporte</h3>
            <p>Verificamos bugs en nuestro sistema para permitirnos optimizar esos daños</p>

          </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="service-item">
            <h3><span>S</span>eguridad</h3>
            <p>Realizamos copias de seguridad diariamente para evitar perdidas en nuestra base de datos</p>
        ...
        <div class="flip-card">
          <!--ACETAMINOFEN-->
            <div class="flip-card-inner">
                <div class="flip-card-front" style="background-image: url(img/ace.png);">
...
<!--PARACETAMOL-->
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front" style="background-image: url(img/para.jpg) ">

                </div>
                <div class="flip-card-back">
                  Los jarabes para la tos están compuestos de ambroxol, dextrometorfano y guaifenesina. Para qué sirve: Se utiliza para calmar la tos seca, irritativa, nerviosa y también actúa sobre los mocos y las flemas.
                </div>
            </div>
        </div>
      ...
      <!--LOSARTAN-->
        <div class="flip-card">
          <div class="flip-card-inner">
              <div class="flip-card-front" style="background-image: url(img/losartan.png); ">

              </div>
              <div class="flip-card-back">
               
                El losartán o losartano​ es un medicamento antagonista de los receptores de angiotensina II usado principalmente para tratar la presión arterial alta. Fue el primer antagonista de la angiotensina II comercializado. Losartán potásico es comercializado por Merck & Co.
   ...
   <div class="container">
    ...
    <div class="cards-grid">
      <div class="flip-card">
        <!--ACETAMINOFEN-->
          <div class="flip-card-inner">
              <div class="flip-card-front" style="background-image: url(img/xray.jpg);">
...
<!--PARACETAMOL-->
      <div class="flip-card">
          <div class="flip-card-inner">
              <div class="flip-card-front" style="background-image: url(img/redox.png) ">

              </div>
              <div class="flip-card-back">
                El paracetamol es un medicamento de venta sin receta médica que se da para aliviar la fiebre y el dolor. Si se utiliza correctamente, es un fármaco seguro para tratar una amplia variedad de problemas. Pero si se da en dosis muy altas puede hacer que el niño se ponga muy enfermo.
              </div>
          </div>
      </div>
    ...
    <!--LOSARTAN-->
      <div class="flip-card">
        <div class="flip-card-inner">
            <div class="flip-card-front" style="background-image: url(img/aspi.png)  ; ">
    ...
    <!--PARTE PARA CONTACTARSE-->
    <section id="contact" class="section-padding wow fadeInUp delay-05s">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center white">
            <h2 class="service-title pad-bt15">Habla con Nosotros</h2>
            <p class="sub-title pad-bt15">Este formulario esta diseñado para ofrecerles a nuestros clientes un servicio de atencion para ello, puede plantear sus inquietudes o recomendaciones para nuestro software</p>
            <hr class="bottom-line white-bg">
          </div>
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="loction-info white">
              <p><i class="fa fa-map-marker fa-fw pull-left fa-2x"></i>Colombia<br>Quibdo - Choco</p>
              <p><i class="fa fa-envelope-o fa-fw pull-left fa-2x"></i>ElectivI@gmai.com</p>
              <p><i class="fa fa-phone fa-fw pull-left fa-2x"></i>+57 300 0002300</p>
            </div>
          </div>
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="contact-form">
              ...
              <form action="" method="post" role="form" class="contactForm">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <input type="text" class="form-control" name="subject" id="subject" placeholder="Sujeto" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
                    <div class="validation"></div>
                  </div>
                </div>
                <div class="col-md-12">
